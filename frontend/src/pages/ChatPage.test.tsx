...
vi.mock("../api/client", () => ({
  api: {
    documents: () => Promise.resolve({ documents: [{ id: "d1", original_filename: "guide.txt", status: "ready" }] }),
    ...
    streamAsk: async (_payload: unknown, onToken: (token: string) => void) => {
      ...
      return {
        ...
        sources: [{ document_id: "d1", document_name: "guide.txt", chunk_number: 1, excerpt: "Grounded answer", relevance_score: 0.9 }],
      };
    },
